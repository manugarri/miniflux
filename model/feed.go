...
func (f *Feed) WithBrowsingParameters(crawler bool, userAgent, username, password, scraperRules, rewriteRules, blacklistRules string) {
	f.Crawler = crawler
    ...
    f.BlacklistRules = blacklistRules
}
